...
public class ETFConfigScreen {
    ...
    public Screen getConfigScreen(Screen parent, boolean isTransparent) {
        ...
        ConfigBuilder builder = ConfigBuilder.create()
                ...
                .setTitle(Text.translatable("config." + ETFClient.MOD_ID + ".title"))
                .setSavingRunnable(() -> {
                    saveConfig();
                    resetVisuals();
                });
        ...
        // random settings
        SubCategoryBuilder randomSettings = entryBuilder.startSubCategory(Text.translatable("config." + ETFClient.MOD_ID + ".random_settings.title"));
        randomSettings.add(0, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".enable_custom_textures.title"), ETFConfigData.enableCustomTextures)
                .setDefaultValue(true) // Recommended: Used when user click "Reset"
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".enable_custom_textures.tooltip")) // Optional: Shown when the user hover over this option
                .setSaveConsumer(newValue -> ETFConfigData.enableCustomTextures = newValue) // Recommended: Called when user save the config
                .build());
        randomSettings.add(1, entryBuilder.startEnumSelector(Text.translatable("config." + ETFClient.MOD_ID + ".texture_update_frequency.title"), ETFConfig.UpdateFrequency.class, ETFConfigData.textureUpdateFrequency_V2)
                .setDefaultValue(ETFConfig.UpdateFrequency.Fast)
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".texture_update_frequency.tooltip")) // Optional: Shown when the user hover over this option
                .setSaveConsumer(newValue -> ETFConfigData.textureUpdateFrequency_V2 = newValue)
                .build());
        randomSettings.add(2, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_update_properties.title"), ETFConfigData.restrictUpdateProperties)
                .setDefaultValue(true)
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_update_properties.tooltip")) // Optional: Shown when the user hover over this option
        ...
        restrictionSettings.add(0, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_biome.title"), ETFConfigData.restrictBiome).setDefaultValue(true)
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_biome.tooltip")).setSaveConsumer(newValue -> ETFConfigData.restrictBiome = newValue).build());
        restrictionSettings.add(1, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_height.title"), ETFConfigData.restrictHeight).setDefaultValue(true)
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_height.tooltip")).setSaveConsumer(newValue -> ETFConfigData.restrictHeight = newValue).build());
        restrictionSettings.add(2, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_block.title"), ETFConfigData.restrictBlock).setDefaultValue(true)
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_block.tooltip")).setSaveConsumer(newValue -> ETFConfigData.restrictBlock = newValue).build());
        restrictionSettings.add(3, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_weather.title"), ETFConfigData.restrictWeather).setDefaultValue(true)
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_weather.tooltip")).setSaveConsumer(newValue -> ETFConfigData.restrictWeather = newValue).build());
        restrictionSettings.add(4, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_day_time.title"), ETFConfigData.restrictDayTime).setDefaultValue(true)
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_day_time.tooltip")).setSaveConsumer(newValue -> ETFConfigData.restrictDayTime = newValue).build());
        restrictionSettings.add(5, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_moon_phase.title"), ETFConfigData.restrictMoonPhase).setDefaultValue(true)
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".restrict_moon_phase.tooltip")).setSaveConsumer(newValue -> ETFConfigData.restrictMoonPhase = newValue).build());
        randomSettings.add(restrictionSettings.build());
        category.addEntry(randomSettings.build());

        // emissive settings
        SubCategoryBuilder emissiveSettings = entryBuilder.startSubCategory(Text.translatable("config." + ETFClient.MOD_ID + ".emissive_settings.title"));
        emissiveSettings.add(entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".enable_emissive_textures.title"), ETFConfigData.enableEmissiveTextures)
                .setDefaultValue(true) // Recommended: Used when user click "Reset"
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".enable_emissive_textures.tooltip")) // Optional: Shown when the user hover over this option
        ...
        emissiveSettings.add(entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".always_check_vanilla_emissive_suffix.title"), ETFConfigData.alwaysCheckVanillaEmissiveSuffix)
                .setDefaultValue(true) // Recommended: Used when user click "Reset"
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".always_check_vanilla_emissive_suffix.tooltip")) // Optional: Shown when the user hover over this option
        ...
        blinkingMobSettings.add(0, entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".blinking_mob_settings.title"), ETFConfigData.enableBlinking)
                ...
                .build()); // Builds the option entry for cloth config
        blinkingMobSettings.add(1, entryBuilder.startIntSlider(Text.translatable("config." + ETFClient.MOD_ID + ".blink_frequency.title"), ETFConfigData.blinkFrequency, 1, 200)
                .setDefaultValue(200) // Recommended: Used when user click "Reset"
                .setMin(1)
                .setMax(1024)
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".blink_frequency.tooltip")) // Optional: Shown when the user hover over this option
                .setSaveConsumer(newValue -> ETFConfigData.blinkFrequency = newValue) // Recommended: Called when user save the config
                .build()); // Builds the option entry for cloth config
        blinkingMobSettings.add(2, entryBuilder.startIntSlider(Text.translatable("config." + ETFClient.MOD_ID + ".blink_length.title"), ETFConfigData.blinkLength, 0, 20)
                .setDefaultValue(1) // Recommended: Used when user click "Reset"
                .setMin(0)
                .setMax(20)
                .setTooltip(Text.translatable("config." + ETFClient.MOD_ID + ".blink_length.tooltip")) // Optional: Shown when the user hover over this option
...
//                .build());
        ...
        category.addEntry(entryBuilder.startBooleanToggle(Text.translatable("config." + ETFClient.MOD_ID + ".elytra_thickness_fix.title"), ETFConfigData.elytraThicknessFix)
                ...
                .build()); // Builds the option entry for cloth config
        category.addEntry(entryBuilder.startEnumSelector(Text.translatable("config." + ETFClient.MOD_ID + ".debug_logging_mode.title"), ETFConfig.DebugLogMode.class, ETFConfigData.debugLoggingMode)
