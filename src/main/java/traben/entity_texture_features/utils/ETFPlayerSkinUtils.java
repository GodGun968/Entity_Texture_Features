                ...
                /*System.out.println(p.getValue());
{
  ...
  "textures" : {
            ...
            if (image != null) {
                ...
                if (UUID_PLAYER_HAS_ENCHANT_SKIN.containsKey(id)) {
                    if (UUID_PLAYER_HAS_ENCHANT_SKIN.getBoolean(id)) {
                        ...
                        if (checkCape != null) {
                            registerNativeImageToIdentifier(checkCape, SKIN_NAMESPACE + id + "_cape_enchant.png");
                        }
                    }
                }
                if (UUID_PLAYER_HAS_EMISSIVE_SKIN.containsKey(id)) {
                    if (UUID_PLAYER_HAS_EMISSIVE_SKIN.getBoolean(id)) {
                        ...
                        if (checkCapeEmissive != null) {
                            registerNativeImageToIdentifier(checkCapeEmissive, SKIN_NAMESPACE + id + "_cape_e.png");
                        }
                    }
                }
                ...
                ETFUtils2.logMessage("Player skin {" + player.getName().getString() + "} no THIRD_PARTY_CAPE Found", false);
                registerNativeImageToIdentifier(Objects.requireNonNullElseGet(ETFUtils2.getNativeImageElseNull(new Identifier("etf:textures/capes/error.png")), ETFUtils2::emptyNativeImage), SKIN_NAMESPACE + id + "_cape.png");
    ...
    private static void skinLoaded(PlayerEntity player, NativeImage skin, @Nullable NativeImage cape) {
        ...
        if (skin != null) {
            if (skin.getColor(1, 16) == -16776961 &&
                ...
                ETFUtils2.logMessage("Found Player {" + id + "} with texture features in skin.", false);
                ...
                if (blinkChoice >= 1 && blinkChoice <= 5) {
                    //check if lazy blink
                    //todo rewrite PATH_HAS_BLINK_TEXTURE.put(SKIN_NAMESPACE + id + ".png", true);
                    if (blinkChoice <= 2) {
                        ...
                        if (blinkChoice == 2) {
                            ...
                            //todo rewrite PATH_HAS_BLINK_TEXTURE_2.put(SKIN_NAMESPACE + id + ".png", true);
                            registerNativeImageToIdentifier(blinkSkinFile2, SKIN_NAMESPACE + id + "_blink2.png");
                        } else {
                            //todo rewrite PATH_HAS_BLINK_TEXTURE_2.put(SKIN_NAMESPACE + id + ".png", false);
                        }
                ...
                //todo rewrite if (!PATH_HAS_BLINK_TEXTURE.containsKey(SKIN_NAMESPACE + id + ".png")) {
                //todo rewrite     PATH_HAS_BLINK_TEXTURE.put(SKIN_NAMESPACE + id + ".png", false);
                //todo rewrite }
                //todo rewrite if (!PATH_HAS_BLINK_TEXTURE_2.containsKey(SKIN_NAMESPACE + id + ".png")) {
                //todo rewrite     PATH_HAS_BLINK_TEXTURE_2.put(SKIN_NAMESPACE + id + ".png", false);
                //todo rewrite }
                ...
                if ((capeChoice1 >= 1 && capeChoice1 <= 3) || capeChoice1 == 666) {
                    switch (capeChoice1) {
                        ...
                        case 666 ->
                                cape = ETFUtils2.getNativeImageElseNull(new Identifier("etf:textures/capes/error.png"));
                        default -> {
                ...
                if (markerChoices.contains(2)) {
                    ...
                    if (check != null) {
                        ...
                        if (blinkSkinFile != null) {
                            ...
                            registerNativeImageToIdentifier(Objects.requireNonNullElseGet(checkBlink, ETFUtils2::emptyNativeImage), SKIN_NAMESPACE + id + "_blink_enchant.png");
                        }
                        if (blinkSkinFile2 != null) {
                            NativeImage checkBlink = returnMatchPixels(blinkSkinFile2, boxChosenBounds);
                            registerNativeImageToIdentifier(Objects.requireNonNullElseGet(checkBlink, ETFUtils2::emptyNativeImage), SKIN_NAMESPACE + id + "_blink2_enchant.png");
                        }
                        if (coatSkin != null) {
                            NativeImage checkCoat = returnMatchPixels(coatSkin, boxChosenBounds);
                            UUID_PLAYER_HAS_ENCHANT_COAT.put(id, checkCoat != null);
                            if (checkCoat != null) {
                                registerNativeImageToIdentifier(checkCoat, SKIN_NAMESPACE + id + "_coat_enchant.png");
                            }
                        }
                        if (cape != null) {
                ...
                if (markerChoices.contains(1)) {
                    ...
                    if (check != null) {
                        ...
                        if (coatSkin != null) {
                            ...
                            if (checkCoat != null) {
                                registerNativeImageToIdentifier(checkCoat, SKIN_NAMESPACE + id + "_coat_e.png");
                            }
                        }
                        if (cape != null) {
                            NativeImage checkCape = returnMatchPixels(skin, boxChosenBounds, cape);
                            ...
                            if (checkCape != null) {
                                registerNativeImageToIdentifier(checkCape, SKIN_NAMESPACE + id + "_cape_e.png");
                            }
                        } else if (thirdPartyCapeWaiting) {
    ...
    private static NativeImage returnCustomTexturedCape(NativeImage skin) {
        ...
        NativeImage elytra = ETFUtils2.getNativeImageElseNull(new Identifier("etf:textures/capes/default_elytra.png"));
        if (elytra == null) {
            elytra = ETFUtils2.getNativeImageElseNull(new Identifier("textures/entity/elytra.png"));
        }//not else
        if (elytra != null) {
    ...
    public static void registerNativeImageToIdentifier(NativeImage img, String identifierPath) {
        ETFUtils2.registerNativeImageToIdentifier(img, new Identifier(identifierPath));
    }
}
